...
<section class="about">
    <div class="container">
        ...
        <div class="row about__items justify-content-around">
            <div class="col-xl-3 ml-5 col-md-5  "><img src="img/internet.png.png" alt="">
            ...
            <div class="col-xl-3 col-md-5 "><img src="img/transfer.png.png" alt="">
                <h3 class="about_h3">One Page</h3>
                <p class="about__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor</p>
            </div>
            <div class="col-xl-3 mr-5 col-md-5  about__items_last  "><img src="img/head.png.png" alt="">
...
<section class="servises">
    <div class="container">
        ...
        <div class="row servises__item   ">
            <div class="col-xl-3 "><img src="img/smartphone_copy.png" alt="">
            ...
            <div class="col-xl-3  ml-4  "><img src="img/smartphone_copy.png" alt="">
                <h4 class="servises__title_item>">Portfolio</h4>
                <p class="servises__text_item">
                    At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum iti
                    atque corrupti quos.
...
<section class="photo">
    <div class="container">
        <div class="row photo__elements ">
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/ite1m.png" alt=""></div>
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/item.png" alt=""></div>
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/item2.png" alt=""></div>
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/Layer_4.png" alt=""></div>
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/Layer_5.png" alt=""></div>
            <div class="col-xl-3 col-md-5 photo__elem"><img class="img-fluid" src="img/Layer_6.png" alt=""></div>
        </div>
        <div class="row justify-content-center">
...
<section class="contacts">
    <div class="container">
        ...
        <div class="row contacts__contact justify-content-center ">
            <div class="col-xl-3">
                <img class="contacts__contact_img" src="img/5555555.png" alt="">
                <p class="contacts__contact_text">Nobinagar savar,Dhaka Bangladesh</p>
            </div>


            <div class="col-xl-3">
                <img class="contacts__contact_img" src="img/2-layers.png" alt="">
                <p class="contacts__contact_text">+8801743331996
                    +8801928737807</p>
            </div>
            <div class="col-xl-3">
                <img class="contacts__contact_img" src="img/2-layers%20(1).png" alt="">
